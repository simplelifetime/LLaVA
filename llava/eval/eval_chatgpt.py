...
def main(args):
    ...
    for idx, r in tqdm(enumerate(res)):
        gold_answer = annotations[idx][args.anskey]
    ...
    if args.eval_only:
        ...
        json.dump(response_list, open(args.output_file, 'w'), indent=4)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--openaikey", type=str, default="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")
